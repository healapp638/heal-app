...
const UserChallengesHandler = {
    list: (userId) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const [dailyChallenges, weeklyChallenges] = yield Promise.all([
            yield user_daily_challenges_model_1.default.find({ user_id: userId, status: workflow_constant_1.USER_STATUS.ACTIVE }),
            yield user_weekly_challenges_model_1.default.find({ user_id: userId, status: workflow_constant_1.USER_STATUS.ACTIVE })
        ]);
