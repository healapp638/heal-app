...
const user_auth_handler_1 = __importDefault(require("../UserAuth/user.auth.handler"));
...
*/
    getUserDetailsUser() {
        return __awaiter(this, void 0, void 0, function* () {
            const wrappedFunc = (0, config_util_1.tryCatchWrapper)(user_auth_handler_1.default.getUserDetailsUser);
            return wrappedFunc(this.userId); // Invoking the wrapped function 
        });
    }
    //ends
...
*/
   ...
   */
    userTrialSubscription() {
        return __awaiter(this, void 0, void 0, function* () {
            const wrappedFunc = (0, config_util_1.tryCatchWrapper)(user_auth_handler_1.default.userTrialSubscription);
            return wrappedFunc(this.userId); // Invoking the wrapped function
        });
    }
    //ends
    ...
    progressTrackerList() {
        return __awaiter(this, void 0, void 0, function* () {
            const wrappedFunc = (0, config_util_1.tryCatchWrapper)(user_auth_handler_1.default.progressTrackerList);
            return wrappedFunc(this.userId); // Invoking the wrapped function
        });
    }
    //ends
...
__decorate([
    (0, tsoa_1.Security)("Bearer"),
    (0, tsoa_1.Get)("/trialSubscription"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], UserAuthController.prototype, "userTrialSubscription", null);
__decorate([
    (0, tsoa_1.Security)("Bearer"),
    (0, tsoa_1.Get)("/progress_tracker_list"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
