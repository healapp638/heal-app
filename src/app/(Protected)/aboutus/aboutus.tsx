...
export default function AboutUs() {
    ...
    const UpdateCommonContent = async () => {
        ...
        await tryCatchWrapper(
            ...
            {
                errorMessage: 'Failed to update About Us content',
                showToast: true,
                onError(error) {
                    logger.error('Failed to update About Us content', error);
                }
            }
        );
    }
    ...
    const ResetCommonContent = async () => {
        ...
        await tryCatchWrapper(
            ...
            {
                errorMessage: 'Failed to reset About Us content',
                showToast: true,
                onError(error) {
                    logger.error('Failed to reset About Us content', error);
                }
            }
        );
    }
