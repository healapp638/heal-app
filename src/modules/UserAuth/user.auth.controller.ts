...
export default class UserAuthController extends Controller {
    ...
    //   */
    @Post("/social_login")
    public async socialLogin(@FormField() login_source: string, @FormField() social_auth: string, @FormField() email: string, @FormField() name?: string, @FormField() os_type?: string, @FormField() language?: string, @FormField() timeZone?: string,@FormField() fullName?: string, @FormField() hearAboutUs?: string, @FormField() howFellingLately?: string, @FormField() feelThatWay?: string, @FormField() likeToFellMore?: string, @FormField() helpFeelBetter?: string, @FormField() stopFeelBetter?: string, @FormField() timeYouCommit?: string, @FormField() goalStartWith?: string): Promise<ApiResponse> {
