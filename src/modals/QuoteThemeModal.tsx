...
const QuoteThemeModal = ({ visible, onClose }: QuoteThemeModalProps) => {
  ...
  const themeOptions = [
    { id: 1, name: 'Minimal', color: '#F4EEE2' },
    { id: 2, name: 'Midnight', color: '#1E1D21' },
    { id: 3, name: 'Ocean', color: '#E0F2F1' },
    { id: 4, name: 'Sunset', color: '#FFF3E0' },
    { id: 5, name: 'Forest', color: '#E8F5E9' },
    { id: 6, name: 'Lavender', color: '#F3E5F5' },
  ];
          ...
          <View style={styles.section}>
            ...
            <View style={styles.fontRow}>
              <TouchableOpacity style={styles.fontItem}>
                <SolidText style={[styles.fontPreview, { fontFamily: AppFonts.reco }]}>Aa</SolidText>
                <SolidText style={styles.fontName}>Reco</SolidText>
              </TouchableOpacity>
              <TouchableOpacity style={styles.fontItem}>
                <SolidText style={[styles.fontPreview, { fontFamily: AppFonts.medium }]}>Aa</SolidText>
                <SolidText style={styles.fontName}>Medium</SolidText>
              </TouchableOpacity>
              <TouchableOpacity style={styles.fontItem}>
                <SolidText style={[styles.fontPreview, { fontFamily: AppFonts.regular }]}>Aa</SolidText>
