...
import { Modal, StyleSheet, TouchableWithoutFeedback, View, Image, Platform, FlatList, TouchableOpacity, Dimensions } from 'react-native';
...
const QuoteThemeModal = ({
  visible,
  onClose
}: QuoteThemeModalProps) => {
  const {
    colors,
    images
  } = useTheme() as any;
  ...
  const renderThemeItem = ({
    item
  }: any) => <TouchableOpacity style={styles.themeItem}>
  ...
  return <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose} statusBarTranslucent>
      <View style={styles.overlay}>
        <TouchableWithoutFeedback onPress={(...args: any) => {
        ...
        <View style={styles.sheetContainer}>
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={(...args: any) => {
            triggerHaptic("impactHeavy");
            return (onClose as any)(...args);
          }}>
          ...
          <View style={styles.section}>
            ...
            <FlatList data={themeOptions} renderItem={renderThemeItem} keyExtractor={item => item.id.toString()} horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.listContent} />
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.fontRow}>
              <TouchableOpacity style={styles.fontItem}>
                <SolidText style={[styles.fontPreview, {
          ...
          <View style={styles.footer}>
            <TouchableOpacity style={styles.unlockAllBtn}>
              <SolidText style={styles.unlockAllTxt}>Unlock All Themes</SolidText>
            </TouchableOpacity>
          </View>
        </View>
      </View>
